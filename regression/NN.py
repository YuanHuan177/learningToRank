...
from utils import predictTargets
...
class NN(NNfuncs.NN):
    ...
    def fit(self, fit_X, fit_y, batchsize=100, n_epoch=10, n_units1=512, n_units2=128, tv_ratio=0.95, optimizerAlgorithm="Adam", savefigName="NNresult.png", savemodelName="NNMLP.model"):
